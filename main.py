...
# Buttons
start_button = Button(text="start", bg=PINK, fg="white", font=(FONT_NAME, 10,), command=start_timer)
start_button.grid(row=2, column=0)

reset_button = Button(text="reset", bg=PINK, fg="white", font=(FONT_NAME, 10, "bold"), command=reset_timer)
